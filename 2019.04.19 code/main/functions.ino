void pin_define(){          //defining pins whether input or output
...
void wall_follow_sense(){      //wall fllow pin configuration
...
void wall_follow_algo(){     // wall following alogorithm
  if (left_distance<3){
    turn_right();
    }
...
void leftEncoderEvent() {                     // encoder event for the interrupt call
...
void rightEncoderEvent() {                     // encoder event for the interrupt call
